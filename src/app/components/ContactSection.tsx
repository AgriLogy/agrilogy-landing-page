    ...
    <Container maxW="4xl">
      <VStack spacing={10} position="relative" paddingTop={10} width="full">
        ...
        <Box textAlign="center">
          ...
          <Heading size="xl" color="green.600" mb={2}>Contact Us</Heading>
        ...
        <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={8} w="100%">
                ...
                <Stack spacing={4}>
                  <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
                    <FormControl isRequired>
                      <FormLabel color="green.600" fontSize="sm">Nom</FormLabel>
                      <Input name="last_name" placeholder="Nom" borderRadius="xl" borderColor={borderColor} focusBorderColor="green.500" />
                    </FormControl>
                    <FormControl isRequired>
                      <FormLabel color="green.600" fontSize="sm">Prénom</FormLabel>
                      <Input name="first_name" placeholder="Prénom" borderRadius="xl" borderColor={borderColor} focusBorderColor="green.500" />
                    </FormControl>
                  </SimpleGrid>

                  <FormControl isRequired>
                    <FormLabel color="green.600" fontSize="sm">Email</FormLabel>
                    <Input name="reply_to" type="email" placeholder="Email" borderRadius="xl" borderColor={borderColor} focusBorderColor="green.500" />
                  </FormControl>

                  <FormControl isRequired>
                    <FormLabel color="green.600" fontSize="sm">Message</FormLabel>
                    <Textarea name="message" placeholder="Message..." rows={4} borderRadius="xl" borderColor={borderColor} focusBorderColor="green.500" />
                  </FormControl>
          ...
          <Card bg={cardBg} borderRadius="2xl" boxShadow="card" borderWidth="1px" borderColor={borderColor} w="100%" _hover={{ boxShadow: "card-hover" }} transition="all 0.2s">
            <CardBody display="flex" flexDirection="column" justifyContent="center" gap={6} py={8} px={6}>
              <Heading size="md" color="green.600" mb={2}>Get in touch</Heading>
              <VStack align="stretch" spacing={4}>
                <HStack align="flex-start" spacing={4} p={4} borderRadius="xl" bg={infoBlockBg} _hover={{ bg: infoBlockHoverBg }} transition="background 0.2s">
                  ...
                  <Box>
                    <Text fontSize="xs" fontWeight="semibold" color="green.600" textTransform="uppercase" letterSpacing="wider" mb={1}>Email</Text>
                ...
                <HStack align="flex-start" spacing={4} p={4} borderRadius="xl" bg={infoBlockBg} _hover={{ bg: infoBlockHoverBg }} transition="background 0.2s">
                  ...
                  <Box>
                    <Text fontSize="xs" fontWeight="semibold" color="green.600" textTransform="uppercase" letterSpacing="wider" mb={1}>Phone</Text>
                ...
                <HStack align="flex-start" spacing={4} p={4} borderRadius="xl" bg={infoBlockBg} _hover={{ bg: infoBlockHoverBg }} transition="background 0.2s">
                  ...
                  <Box>
                    <Text fontSize="xs" fontWeight="semibold" color="green.600" textTransform="uppercase" letterSpacing="wider" mb={1}>Visit us</Text>
                    <Text color="green.700" fontWeight="medium" _dark={{ color: "green.300" }}>Morocco, Casablanca</Text>
                  </Box>
                </HStack>
              </VStack>
            </CardBody>
